...
class countstars
{
	public:
		...
		void print()
		{
			char* ptr[8]={"sunday","monday","tuesday","wednesday","thursday","friday","saturday","sunday"};
...
int main()
{
	...
	//cout<<o.evaluate();
	o.count();
	cout<<"Total stars count:"<<o.totalstarscount()<<endl;
	o.print();
	getch();
	return 0;
}
